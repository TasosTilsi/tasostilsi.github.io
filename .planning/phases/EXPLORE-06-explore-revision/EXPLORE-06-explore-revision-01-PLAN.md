...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/data/portfolio-main-data.d.ts"
      provides: "Types for the new fields: core_competencies: { name: string; proof: string }[] and featured?: boolean on Certification + Article + Project + Education (checker B-1/B-2 fix — /resume + PDF consume featured projects and featured education)"
      min_lines: 100
