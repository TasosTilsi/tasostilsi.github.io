...
export const HelpOutput = () => (
  <>
    ...
    <ul className="list-none pl-2 space-y-1">
      ...
      <li><span className="text-primary w-36 inline-block">explore</span>                - Open the visual portfolio tour</li>
      <li><span className="text-primary w-36 inline-block">taas</span>                   - Part-time engagements (TAaS)</li>
