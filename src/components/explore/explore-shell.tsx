 ...
 * header bar → typewriter intro strip (optional `intro` slot, plan 02) →
 * main (the ONLY scroll container) → status bar. The theme instance is
 * passed down as props so the header toggle and the status-bar live label
 * share one source of truth (key_link).
 *
