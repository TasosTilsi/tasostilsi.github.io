 ...
 *
 * ProjectStatTiles (D-03) opens the body — the three JSON-derived summary
 * tiles above the cards — values from viz-data's projectStats (EXPLORE-07);
 * the wrapper's mb-3 gives the intentional 12px tiles→cards gap versus the 8px
 * card-card rhythm (§1). The card map below stays byte-identical. The
 * phase-6 year-grid calendar is GONE (EXPLORE-07 REV-08/D-03) — the body
 * renders tiles + cards only, with no chart import or geometry gate.
 *
