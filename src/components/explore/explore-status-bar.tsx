 ...
 * `N/4 sections visited` counter (EXPLORE-04c, D-06; W-1 — the merged grid
 * has 4 sections) — N flows in from ExploreShell's single useExploreVisited
 * instance as the visitedCount prop (drawer anchors, manual scroll, and
 * wizard arrivals all mark through that one IO path); the 4 derives from
 * EXPLORE_SECTIONS. At 4/4 the counter span renders text-accent — the
 * phase's only celebration visual (E-13; no toast, no confetti — dropped
 * scope).
 *
